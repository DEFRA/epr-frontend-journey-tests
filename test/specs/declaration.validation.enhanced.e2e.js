...
describe.skip('Declaration name validation @declarationValidation', () => {
  before(async () => {
  ...
  it('should show error when name is empty @declarationValidationEmpty @enhancedCheck', async () => {
  ...
  it('should show error when name is too short @declarationValidationTooShort @enhancedCheck', async () => {
  ...
  it('should show error when name is too long @declarationValidationTooLong @enhancedCheck', async () => {
  ...
  it('should show error when name contains invalid characters @declarationValidationInvalidChars @enhancedCheck', async () => {
  ...
  it('should submit successfully with a valid name @declarationValidationHappyPath @enhancedCheck', async () => {
