...
describe.skip('Stale summary log report @staleReport', () => {
  it('should redirect to the stale SL error page when navigating to a stale report, with working Return and Delete buttons and unable to submit a stale ready-to-submit report @staleReportSubmit @staleReportNavigation @enhancedCheck', async () => {
    ...
    await DashboardPage.selectTableLink(1, 1)
    await WasteRecordsPage.submitSummaryLogLink()
    await EnhancedUploadSummaryLogPage.performUploadAndReturnToHomepage(PL_FILE)
  ...
  it('should redirect to the stale SL error page when navigating to a stale report (Registered Only), and unable to submit a stale in-progress report @staleReportSubmit @staleReportInProgress @enhancedCheck', async () => {
