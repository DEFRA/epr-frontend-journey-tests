...
describe.skip('Registered-only exporter report flow @registeredOnlyExporter', () => {
  it('should complete the full registered-only exporter report flow through to confirmation @registeredOnlyExporterFullFlow @smoketest @enhancedCheck', async () => {
  ...
  it('should return 404 when navigating directly to PERN pages @registeredOnlyExporterRouteGuard @enhancedCheck', async () => {
  ...
  it('should redirect to reports list when navigating back to check-answers after report is created @registeredOnlyExporterCheckAnswersGuard @enhancedCheck', async () => {
    await setupRegisteredOnlyExporter()
    await uploadAndNavigateToReports()
  ...
  it('should redirect to submitted confirmation page when navigating back to submit after submission @registeredOnlyExporterSubmitGuard @enhancedCheck', async () => {
    await setupRegisteredOnlyExporter()
    await uploadAndNavigateToReports()
  ...
  it('should navigate back correctly through the registered-only exporter flow @registeredOnlyExporterBackLinks @enhancedCheck', async () => {
    await setupRegisteredOnlyExporter()
    await uploadAndNavigateToReports()
