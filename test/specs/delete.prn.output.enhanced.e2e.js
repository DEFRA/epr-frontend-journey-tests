...
describe.skip('Deleting Packing Recycling Notes (Reprocessor Output)', () => {
  it('Should be able to create and delete PRN for Plastic (Reprocessor Output) @delprnoutput @smoketest @enhancedCheck', async () => {
