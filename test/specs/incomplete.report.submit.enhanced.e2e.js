...
describe.skip('Incomplete report submit @incompleteReportBlock', () => {
  before(async () => {
  ...
  it('rejects submit on check-your-answers when manual fields are unpopulated @incompleteReportBlockReprocessor @enhancedCheck', async () => {
