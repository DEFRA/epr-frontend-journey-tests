...
describe.skip('Registered-only reprocessor report flow @registeredOnlyReprocessor', () => {
  it('should complete the full registered-only reprocessor report flow through to confirmation @registeredOnlyReprocessorFullFlow @enhancedCheck', async () => {
  ...
  it('should return 404 when navigating directly to PRN pages @registeredOnlyReprocessorRouteGuard @enhancedCheck', async () => {
  ...
  it('should redirect to reports list when navigating back to check-answers after report is created @registeredOnlyReprocessorCheckAnswersGuard @enhancedCheck', async () => {
    await setupRegisteredOnlyReprocessor()
    await uploadAndNavigateToReports()
  ...
  it('should navigate back correctly through the registered-only reprocessor flow @registeredOnlyReprocessorBackLinks @enhancedCheck', async () => {
    await setupRegisteredOnlyReprocessor()
    await uploadAndNavigateToReports()
