...
export const config = {
  ...
  baseUrl: `https://epr-frontend-journey-tests.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `epr-frontend-journey-tests-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `epr-frontend-journey-tests-${process.env.ENVIRONMENT}`
        },
